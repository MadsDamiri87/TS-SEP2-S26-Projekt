...
public interface ContentRepository extends JpaRepository<Content, Long>
{
    ...
    List<Content> findAllByLesson_LessonIdOrderByOrderNumberAsc(Long lessonId);

    List<Content> findAllByLesson_LessonIdAndOrderNumberGreaterThan(Long lessonId, int deletedOrderNumber);
}
