...
@JsonPropertyOrder({"username", "email", "phoneNumber",
    "name"}) public record UpdateUserRequest(
    @NotBlank(message = "Username must not be blank") @Size(max = 30, message = "Username must be at most 30 characters") String username,
